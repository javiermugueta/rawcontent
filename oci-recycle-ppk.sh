...
#oci os ns get
docker run -v "/home/vsts/work/1/s/oci:/oracle/.oci" ghcr.io/oracle/oci-cli:latest os ns get
...
newfp="$(docker run -v "/home/vsts/work/1/s/oci:/oracle/.oci" ghcr.io/oracle/oci-cli:latest iam user api-key upload --user-id $ociuser --key-file $pubfile | jq -r '.data.fingerprint')"
#
